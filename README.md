...
> 本仓库仅作示例使用，目的是展示在人力资源有限、需求难度不高、前后端对接问题频发的情况下个人对前端框架设计的思考。部分细节与资源被移除，部分依赖未打包而是直接展示代码。
...
以上结构适用于开发复杂应用。实际情况下需根据项目难度、时间等因素合理简化结构。比如在接口准备充分的情况下，可令api直接对接view，加快开发速度。一般情况下也无需使用mock层的内存数据库。
